        ...
        <table class="table table-bordered">
            <thead>
                <tr>
                    ...
                    <th>Trámite</th> <!-- Columna para Trámite -->
                    <th>Zona</th>
                    <th>X Inicial</th>
                    <th>Y Inicial</th>
                    <th>X Final</th>
            ...
            <tbody>
                ...
                if ($search) {
                    $query = "SELECT p.ci, p.nombre, p.paterno, z.nombre AS zona, c.x_ini, c.y_ini, c.x_fin, c.y_fin, c.superficie, c.distrito, t.tipo_tramite 
                              FROM Persona p 
                              INNER JOIN Catastro c ON p.ci = c.ci_persona
                              LEFT JOIN Tramites t ON c.id_tramite = t.id 
                              LEFT JOIN zonas z ON c.id_zona = z.id  -- JOIN con la tabla de zonas
                ...
                if ($personas) {
                    foreach ($personas as $persona) {
                        ...
                        echo "<td>" . htmlspecialchars($persona['zona'] ?? '') . "</td>"; // Mostrar nombre de la zona
